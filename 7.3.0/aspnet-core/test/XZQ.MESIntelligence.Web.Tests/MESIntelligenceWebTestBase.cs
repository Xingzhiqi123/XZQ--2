...
{
    public abstract class MESIntelligenceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MESIntelligenceWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MESIntelligenceWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MESIntelligenceDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MESIntelligenceDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MESIntelligenceDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MESIntelligenceDbContext, Task<T>> func)
        {
            T result;
