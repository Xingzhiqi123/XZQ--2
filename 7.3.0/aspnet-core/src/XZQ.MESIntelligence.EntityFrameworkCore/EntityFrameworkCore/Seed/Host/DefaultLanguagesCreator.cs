...
namespace XZQ.MESIntelligence.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = MESIntelligenceConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(MESIntelligenceDbContext context)
        {
            _context = context;
        }
