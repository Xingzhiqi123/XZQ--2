...
namespace BlankApp1.ViewModels
{
    public class ViewModel : ModelBase
    {
        ...
        {
            get { return _people ?? (_people = new BindingList<Person>()); }
        ...
        {
            var list = HttpHelper.Get("https://localhost:44311/api/services/app/APJUser/GetAll");
            //SystemHomePageModel1接收list数据

            var show = JsonConvert.DeserializeObject<Root>(list);
        ...
        public void Add()
        {
            ...
            var i = HttpRequest.PostAsyncJson("https://localhost:44311/api/services/app/APJUser/Create", jsonadd);
            People.Add(person);
        }
        public bool CanAdd()
        {
